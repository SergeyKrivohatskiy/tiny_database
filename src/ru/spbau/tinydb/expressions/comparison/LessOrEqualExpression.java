 ...
 * @author adkozlov
 */
public class LessOrEqualExpression<V extends Comparable<V>> extends ComparisonExpression<V> {

    public LessOrEqualExpression(@NotNull SecondLevelId id, @NotNull V value) {
        super(id, value);
    }
